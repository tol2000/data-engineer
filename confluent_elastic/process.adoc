...
------------------------
messages-per-sec:      2.86   total-messages:      1065     last-message: 2020-03-18T12:07:21.617Z
...
Local runtime statistics
------------------------
consumer-messages-per-sec:      4.72 consumer-total-bytes:    445313 consumer-total-messages:      1918 messages-per-sec:      4.70   total-messages:      3644     last-message: 2020-03-18T12:08:33.585Z
```
...
Кафка ничего не знает о структуре данных внутри себя.
